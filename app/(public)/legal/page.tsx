        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          {legalDocs.length === 0 ? (
            <Card className="p-16 text-center">
              ...
              <p className="text-muted-foreground">We're working on uploading our compliance documents</p>
            </Card>
          ) : (
                        ...
                        <div className="grid md:grid-cols-2 gap-x-8 gap-y-3 mb-4">
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-muted-foreground font-mono">{doc.registrationNumber}</div>
                            </div>
                          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                    We believe in full transparency and accountability. All our legal registrations and certifications are available for public review. We maintain compliance with all applicable laws and regulations.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    For any questions about our legal status or compliance, please <a href="/contact" className="text-primary hover:underline">contact us</a>.
                  </p>
                </div>
              </div>
            </CardContent>
